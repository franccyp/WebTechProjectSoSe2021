export default {
    ...
    <p> List Name: <input class="inputbox" v-model="list_name" placeholder="list name"/></p>
        ...
        <p> New Item: <input class="inputbox" id="itemName"  v-model="itemName" placeholder="add a new Item" @keyup.enter="list_items.push(itemName)"/> <button class="button button_webpage" id="addItemButton" type="button" @click="list_items.push(itemName)">Add item</button></p>
